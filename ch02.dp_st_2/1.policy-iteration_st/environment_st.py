...
class GraphicDisplay(tk.Tk):
    ...
    def evaluate_policy(self):
        ...
        for i in self.texts:
            self.canvas.delete(i)
        self.agent.___________()
        self.___________(self.agent.value_table)
    ...
    def improve_policy(self):
        ...
        for i in self.arrows:
            self.canvas.delete(i)
        self.agent.___________()
        self.draw_from_policy(self.agent._________)
...
class Env:
    def __init__(self):
        ...
        self.possible_actions = POSSIBLE_ACTIONS  #[0, 1, 2, 3] 상,하,좌,우
