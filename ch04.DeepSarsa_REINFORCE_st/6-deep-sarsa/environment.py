...
class Env(tk.Tk):
    ...
    def reset(self):
        ...
        self.reset_reward()
        # print('reset()-rewards:', self.rewards) #Add by SOO
        return self.get_state()

    def step(self, action):
        self.counter += 1
        # self.render()  # Chane by SOO
...
#        print('get_state()-states:', states)  #Add by SOO
        return states
...
#        print('move_const()-base_action:', base_action); #Add by SOO
