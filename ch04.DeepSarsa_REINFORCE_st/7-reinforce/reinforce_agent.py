...
class ReinforceAgent:
    def __init__(self):
        ...
        if self.load_model:
#            self.model.load_weights('./save_model/ep2500.h5')
...
#        print('get_action()-policy:', policy) #Add by SOO
    ...
    def train_model(self):
        ...
        # print('-->train_model()-states-len:', len(self.states), 'actions-len:', len(self.actions), 'discounted_rewards-len:', len(discounted_rewards)) #Add by SOO
...
#            print('===>action:', action, 'reward:', reward, 'done:', done, 'next_state:', next_state)  #Add by SOO
        ...
        if e % 100 == 0:
            # agent.model.save_weights("./save_model/soo.h5")
