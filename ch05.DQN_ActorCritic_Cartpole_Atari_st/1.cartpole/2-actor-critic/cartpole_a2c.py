...
class A2CAgent:
    ...
    def train_model(self, state, action, reward, next_state, done):
        ...
        # print('-->train_model()-advantage:', advantage)  # Add by SOO
...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            cnt += 1  # Add by SOO
            # print("step:", cnt, "  score:", score)  # Add by SOO
            ...
            if done:
                ...
                print("episode:", e, "step:", cnt, "  score:", score)  # Change by SOO
