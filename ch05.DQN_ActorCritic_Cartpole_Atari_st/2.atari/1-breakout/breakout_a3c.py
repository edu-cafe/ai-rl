...
class A3CAgent:
    ...
    def train(self):
        ...
        # 각 쓰레드 시작
        thread_id = 0  # Add by SOO
        for agent in agents:
            time.sleep(1)
            thread_id += 1  # Add by SOO
            agent.id = thread_id  # Add by SOO
            agent.start()
...
class Agent(threading.Thread):
    ...
    def run(self):
        ...
        while episode < EPISODES:
            ...
            while not done:
                if render and self.id==1:     env.render()  # Add by SOO
                step += 1
                self.t += 1
                observe = next_observe
                ...
                if done:
                    ...
                    #       step)
                    print("--->ID:", self.id, "episode:", episode, "  score:", score, "  step:",
                          step)  # Change by SOO
